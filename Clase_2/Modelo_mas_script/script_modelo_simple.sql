...
CREATE TABLE IF NOT EXISTS `mydb`.`jugador` (
  ...
  INDEX `fk_jugador_equipo_idx` (`equipo_id_equipo` ASC),
  INDEX `fk_jugador_posicion1_idx` (`posicion_id_posicion` ASC),
  INDEX `fk_jugador_nacionalidad1_idx` (`nacionalidad_id_nacionalidad` ASC),
