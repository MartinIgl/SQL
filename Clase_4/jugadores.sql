...
INSERT INTO `insert_jugadores` VALUES (1,'curso@localhost',12,'2020-08-23 21:11:47');
...
INSERT INTO `jugador` VALUES (1,'Lionel Andres','Messi',200000,1,1,1),(2,'Cristiano','Ronaldo',200000,2,2,2),(3,'Neymar','Jr',55000,3,3,2),(4,'Jan','Oblak',44000,4,4,3),(5,'Eden','Hazard',63000,5,5,2),(6,'Marc-Andre','ter Stegen',60000,6,1,3),(7,'Virgil','Van Dijk',58000,7,6,4),(8,'Paulo','Dybala',62000,1,2,6),(9,'Scott','Carson',45000,8,7,3),(10,'Kyle','Walker',47000,8,7,4),(11,'Sergio','Aguero',62000,1,7,5),(12,'Robert','Lewandowski',150000,9,8,5);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`curso`@`localhost`*/ /*!50003 TRIGGER auditoria_insert_jugadores AFTER INSERT ON jugador FOR EACH ROW INSERT INTO insert_jugadores
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`curso`@`localhost`*/ /*!50003 TRIGGER auditoria_update_jugadores BEFORE UPDATE ON jugador FOR EACH ROW INSERT INTO update_jugadores
(usuario_updateo, id_jugador_modificado, sueldo_mensual_antes, sueldo_mensual_despues, fecha_modificacion)
...
INSERT INTO `update_jugadores` VALUES (1,'curso@localhost',1,175000,175000,'2020-08-23 21:12:16'),(2,'curso@localhost',1,175000,200000,'2020-08-23 21:13:19');
...
/*!50001 VIEW `sueldo_jugadores` AS select `jugador`.`nombre` AS `nombre`,`jugador`.`apellido` AS `apellido`,`jugador`.`sueldo_mensual` AS `sueldo_mensual` from `jugador` */;
...
-- Dump completed on 2020-08-23 21:14:03
